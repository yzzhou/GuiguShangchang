...
import myapplication.guigushangchang.shoppingcart.adapter.ShoppingCartAdapter;
import myapplication.guigushangchang.shoppingcart.pay.PayResult;
import myapplication.guigushangchang.shoppingcart.pay.SignUtils;
...
//                Toast.makeText(mContext, "全选-结算", Toast.LENGTH_SHORT).show();
...
//                Toast.makeText(mContext, "全选-删除", Toast.LENGTH_SHORT).show();
